...
## 🎰 Gameplay & Mini-Games
**MAPY**
Hráč má k dispozici tři mapy, na kterých se může pohybovat a kde se nachází stanoviště.
...
> Wheel of fortune: *Hra založená na náhodě. Hráč sází na čísla nebo barvy a čeká, kam se zastaví kolo, aby vyhrál tickety, skoro jako při ruletě.*
...
> Lucky Dice: *Strategická hra s kostkami, kde hráč hází s nadějí, že součtem vyhraje nad svým protihráčem.*
...
- dodatečné API: vlastnosti, ukládání pokroku, ID pro obnovu hry
- design: grafika určitých posatv a stánků
- minihry: Risky Turn

**N. Pražáková**
- design: úvodní sekvence, grafika celé hry
- minihry: Cups & Coins, Lucky 
- dodatečné API: ukládání vyhraných ticketů z miniher
